// https://sourcegraph.com/github.com/huruji/rpn.js@2e861f1ff406ce0e07d8f0fec8a5bea780ebfc6b/-/blob/src/index.js#L15
  ...
  while (inputStack.length > 0) {
    ...
    if (isOperator(cur)) {
      if (cur == '(') {
        ...
        while (
          prioraty(cur, outputStack[outputStack.length - 1]) &&
